...
export default function Label() {
  ...
  return (
        ...
        <div style={{display : 'flex', flexDirection : 'column', justifyContent: 'center', paddingTop : 10, paddingBottom : 'auto', marginBottom : 200, right : '5%', width : 53, position : 'fixed', borderRadius : 50, backgroundColor : 'white', border: '3px solid #207872'}}>
