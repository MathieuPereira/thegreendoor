            ...
            <div className="modal" style={{visibility: props.state}}
                ...
                <div className="sign" style={{zIndex: 25}} onClick={e => e.stopPropagation()}>
                    ...
                    <div className="signSection">
                        ...
                        <button className="signButton mt buttonHover" onClick={() => handleSignin()}>Se connecter
                        </button>
                    ...
                    <div className="signSection">
                        ...
                        <form>
                            ...
                            <input type="text" name="input" placeholder="* Votre adresse email" className=""
                                   required={true}
                                   onChange={(e) => setRegisterEmailAdress(e.target.value)}
                                   value={registerEmailAdress}/>
                            <div className="passwordDiv">
                                <input type={isRegisterPasswordVisible} name="input"
                        ...
                        <div className="submitRegister">
                            <p>*Champs Requis</p>
                            <button className="signButton buttonHover" onClick={() => handleSignup()}>S'inscrire
                            </button>
                        </div>
                    </div>
                </div>
