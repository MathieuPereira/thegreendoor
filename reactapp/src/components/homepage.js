   ...
   return (
      ...
      <div style={{backgroundColor: "#FCF5EE", fontFamily: 'Montserrat'}}>
         ...
         >
            ...
            <p>Picture Organic Clothing est la création de 3 jeunes passionnés de montagne : Jérémy, Julien et Vincent.
               Leur priorité : se soucier de l’environnement et le préserver. La conception des produits est la plus
               écologique possible : Ils sont composés de coton biologique, et de matières recyclées, mais ils sont
               également tous labélisés. Cette marque Française se développe très vite à l’international, grâce à ses
               innovations écologiques qu’elle crée chaque année. La gamme de Picture s’étend désormais aux vêtements
               techniques pour le ski et le snowboard, ainsi que des accessoires et vêtements streetwear.</p>
