...
function SalePage(props) {
   ...
   basketArticles = props.basket.map((product, i) => {
      ...
      return (
         ...
         <Col key={i}
              style={{height: 207, border: '1px solid gray', padding: 5, backgroundColor: '#FFFFFF', marginBottom: 15}}>
            <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'flex-start'}}>
               <img style={{width: 150, height: 200}} src={`/assets/Produits/${product.img}.jpeg`} href={`ALPINE PT`}/>
               <div style={{display: "flex", justifyContent: 'space-between', flexDirection: 'row', width: '100%'}}>
                  <div style={{marginLeft: 25, marginTop: 35}}>
                     ...
                     <div style={{marginTop: '20%'}}>
                        ...
                        <Select defaultValue={`${product.size}`} onChange={handleChange}>
                  ...
                  <div style={{marginTop: 35, marginRight: 10}}>
                     <p style={{textDecoration: "line-through", fontSize: 12}}>{product.normalPrice},00 €</p>
                     <p style={{fontSize: 16, fontWeight: 650, color: '#207872'}}>{product.reducedPrice},00 €</p>
                     <Row style={{marginTop: 35, display: "flex", alignItems: "center", cursor: "pointer"}}
                          onClick={() => props.deleteArticle(`${product.name}`)}>
         ...
         <div style={{backgroundColor: "#FCF5EE", fontFamily: 'Montserrat'}}>
            ...
            <div style={{width: '70%', margin: 'auto'}}>
               ...
               <div style={{display: "flex", flexDIrection: 'row', justifyContent: 'space-between'}}>
                  ...
                  <Col style={{width: '30%', border: '1px solid gray', fontSize: 16, fontWeight: 550, padding: 25}}>
                     ...
                     <div style={{display: 'flex', justifyContent: 'space-between', flexDirection: 'row'}}>
                        ...
                        <p style={{fontSize: 14, marginBottom: 0}}>X,00€</p>
                     </div>
                     <span style={{
                        marginTop: 10,
                        marginBottom: 10,
                     ...
                     <div style={{display: 'flex', justifyContent: 'space-between', flexDirection: 'row'}}>
                        ...
                        <p style={{fontSize: 14}}>{totalPrice},00€</p>
                     </div>
...
function mapDispatchToProps(dispatch) {
   return {
      ...
      modifyArticleSize: function (name, value) {
         dispatch({
