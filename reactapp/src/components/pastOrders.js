        ...
        return (
                ...
                <div
                    ...
                    <div style={{display : 'flex', justifyContent : 'space-between',backgroundColor : '#207872', color : 'white', fontFamily : 'Montserrat', fontSize : 15, paddingTop : 10, paddingLeft: 15, paddingBottom : 5, paddingRight : 15}}>
                        <div >
                            <p style={{marginBottom : 3}}>Date de votre commande : <span style={{fontWeight : 'bold'}}>{date}</span> </p>
                            <p style={{marginBottom : 3}}>Total : <span style={{fontWeight : 'bold'}}> {totalCmd}€ </span> dont {order.deliveryPrice}€ de livraison</p>
                        </div>
